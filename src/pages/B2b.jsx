...
export default function B2b() {
  ...
  useEffect(() => {
    if (isInitialLoad.current || !productsLoading) {
      ...
      fetchProducts({ page, limit, productType: "b2b" });
    }
    ...
    <Box component="section" sx={{ pt: 6, pb: 10, minHeight: "100vh" }}>
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            <ScienceIcon sx={{ color: "primary.main", fontSize: 15 }} />
        ...
        >
          ...
          <FormControl size="small" sx={{ minWidth: 90 }}>
            ...
            >
              {[8, 12, 24, 48].map(n => <MenuItem key={n} value={n}>{n}</MenuItem>)}
            </Select>
          </FormControl>
        </Stack>
        ...
        {!productsLoading && sortedProducts.length === 0 && (
          <Box textAlign="center" py={10}>
            <ScienceIcon sx={{ fontSize: 52, color: "rgba(210,178,107,.2)", mb: 2 }} />
